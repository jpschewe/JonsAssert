...
// Define some helper methods
{
  ...
  **/
  private void addAsserts(final Set asserts, final Token jdClose) {
  ...
  private Set _invariants = new HashSet(10);
  ...
  **/
  private void clearInvariants() {
    _invariants = new HashSet(10);
  }


  private Set _preConditions = new HashSet(10);
  /**
  ...
  **/
  public void clearPreConditions() {
    _preConditions = new HashSet(10);
  }

  private Set _postConditions = new HashSet(10);
  /**
  ...
  **/
  public void clearPostConditions() {
    _postConditions = new HashSet(10);
  }    
}
...
parameterDeclarationList returns [Set params]
{
  params = new HashSet(10);
  StringPair pd = null;
}
...
{ Set assertTokens = new HashSet(10); }
  : (JAVADOC_OPEN
    ( assert:ASSERT_CONDITION { assertTokens.add(assert); clearInvariants(); }
      | PRE_CONDITION
      | POST_CONDITION
      | iv:INVARIANT_CONDITION { addInvariant(iv); assertTokens = new HashSet(10); }
    )*
    jdc:JAVADOC_CLOSE 
